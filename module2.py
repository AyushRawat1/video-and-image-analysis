...
import utils
#importing from pipeline class its functions that help us in logging, detecting and writing.
from pipeline import (PipelineRunner, ContourDetection, Visualizer, CsvWriter, VehicleCounter)

IMAGE_DIR = "./out"
VIDEO_SOURCE = "Any mp4 INPUTFILE"
SHAPE = (720, 1280) 
EXIT_PTS = np.array([[[732, 720], [732, 590], [1280, 500], [1280, 720]],[[0, 400], [645, 400], [645, 0], [0, 0]]])

#Subracting static first background frame from next upcoming frames for detecting contoyrs i.e cars
